...
import requests
import json
from models import PeopleModel, SeptemberModel, OctoberModel, NovemberModel, DecemberModel
...
def index():
    ...
    september_objects = SeptemberModel.create_september_objects()
    october_objects = OctoberModel.create_october_objects()
    november_objects = NovemberModel.create_november_objects()
    december_objects = DecemberModel.create_december_objects()
